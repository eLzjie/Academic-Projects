...
public class Medium extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        A_lbl.setFont(new java.awt.Font("Modak", 0, 28)); // NOI18N
        ...
        B_lbl.setFont(new java.awt.Font("Modak", 0, 28)); // NOI18N
        ...
        C_lbl.setFont(new java.awt.Font("Modak", 0, 28)); // NOI18N
        ...
        D_lbl.setFont(new java.awt.Font("Modak", 0, 28)); // NOI18N
...
//        "<html> <style> p { text-align: center; } <style>  <p> question <p/> <html>",
        ...
        private String[] questions = {"<html> <style> p { text-align: center; } <style>  <p> How many partitions can you create for the set <br>P = { 1 , 2 , 3 , 4 } <p/> <html>",
            
                                      "<html> <style> p { text-align: center; } <style> <p> Find the relation. Let, A = {9, 17, 32} and B = {17, 6, 45}. If relation R is 'equal to' (A=B), what are the possible choices for R?<p/> <html>",
            
                                      "<html> <style> p { text-align: center; } <style> <p> Let A={4, 6}, B={2, 4}. If relation R is defined (a / b) = even integer with zero remainder, what are the possible choices for R?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p> Let A={5, 10, 15}, B={3, 5}. If relation R is defined (a / b) = odd integer with zero remainder, we cannot obtain... <p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p> A node or vertex that has no relation/s to any vertices in a graph is called ____. <p/> <html>",
            
                                      "<html> <style> p { text-align: center; } <style>  <p>What is the probability of rock beating paper?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p>What is the probability of paper losing to scissors?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p>If you flipped 2 coins, what is the probability that both will land on tails?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p>Three unbiased coins are tossed. What is the probability of getting at most one tail?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style> <p>How many outcomes are there if you tossed 4 coins?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p> Given sets below, evaluate what kind of set describe or represent them. <br> A = { 1, 3, 5, 7} ; B = { 2, 4, 6, 8, 2} <p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p>Two numbers are selected from a hat containing 20 numbers 1 through 20. What is the probability that one number is not twice the other number selected?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p>How many outcomes are there when you flip 5 coins?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p>What are the chances of rolling a sum of seven in one roll of a pair of fair standard dice?<p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p> In your wallet you have the following paper money: 7 singles, 3 fives, 2 tens, and 6 twenties. What is the probability, as a percent, you will draw a 5 and then a 20?<p/> <html>",
                                     
                                      "<html> <style> p { text-align: center; } <style>  <p> If 5 coins are tossed, in how many ways can it happen that 3 coins fall on tails? <p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style>  <p> In a 3-dimension array: int n[ ] [ ] [ ] =new int [4][5][6]; How many element values in a matrix table of 3-D will you have? <p/> <html>",

                                      "<html> <style> p { text-align: center; } <style>  <p> what is the set of all possible values that the x variable can take in a relation? <p/> <html>",
                                      
                                      "<html> <style> p { text-align: center; } <style> <p> Find the relation. Let, A = {9, 8, 32} and B = {33, 10, 45}. If relation R is 'greater than' (A > B), what are the possible choices for R?<p/> <html>",
            
                                      "<html> <style> p { text-align: center; } <style>  <p> This is also set of y-values <p/> <html>",

                    };
        
        private String[][] choices = { {"5", "9", "10", "20"},
                                       {"(9,9)", "(17,17)" , "(32,32)", "(9,17)"},
                                       {"(4,2)", "(4,4)", "(6,2)", "(4,6)"},
                                       { "(5, 5)", "(15, 3)","(10, 3)", "(15, 5)" },
                                       {"Island", "Terminal","Isolated", "Remote"},
                                       {"1/2", "0", "2/3", "1"},
                                       {"1/4", "0", "1/2", "1/3"},
                                       {"1/2", "1/3", "1/4", "1/6"},
                                       {"0.50", "0.25", "0.125", "0.75"},
                                       {"4", "6", "8", "16"},
                                       {"disjoint", "joint", "equal", "null"},
                                       {"19/20", "18/19", "9/10", "1/10"},
                                       {"15", "16", "25", "32"},
                                       {"1/6", "1/12", "1/8", "1/4"},
                                       {"5.8%", "3.1%", "7.5%", "10%"},
                                       {"8", "9", "10", "15"},
                                       {"26", "54", "15" ,"120"},
                                       {"domain", "range", "function", "equation"},
                                       {"(9,10)", "(32,10)" , "(8,45)", "(32,33)"},
                                       {"domain", "range", "function", "equation"},
                                       

                                    };
        
        private char[] answers = {'B', 'B' , 'A', 'C', 'C', 'B', 'D', 'C', 'A', 'D','A', 'B', 'D', 'A', 'A', 'C', 'D', 'A', 'B', 'B'};
        
        private String[] hints = {"1 to 3, 2 to 2, all 1",
                                  "Elements common to both sets",
                                  "<html> <style> p { text-align: center; } <style>  <p> Divide one number by another to get an even integer with zero remainder<p/> <html>",
                                  "Not divisible by each other",
                                  "It's alone.",
                                  "Rock cant beat paper",
                                  "<html> <style> p { text-align: center; } <style>  <p>there are three possible outcomes (paper, scissors, or rock), and paper loses to scissors in one of these outcomes.<p/> <html>",
                                  "HH, TH, HT, TT",
                                  "4 in 8 outcomes",
                                  "2 raised to the power of number of coins.",
                                  "Not connected",
                                  "<html> <style> p { text-align: center; } <style>  <p>The first number can be any of the 20 numbers. The second number must not be twice the first.<p/> <html>",
                                  "2 raised to the power of number of coins.",
                                  "Probability of success / Probability of failure",
                                  "<html> <style> p { text-align: center; } <style>  <p>Probability of fives * probability of twenties.<p/> <html>",
                                  "5! / 3! 2!",
                                  "4 x 5 x 6",
                                  "dough it's all main",
                                  "Bigger 1st number",
                                  "Your shot is out of ___"
